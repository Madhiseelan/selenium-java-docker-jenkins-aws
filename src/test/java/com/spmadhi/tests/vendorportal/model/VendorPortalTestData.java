package com.spmadhi.tests.vendorportal.model;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.spmadhi.tests.vendorportal.VendorPortalTest;
...
public class VendorPortalTestData {
    ...
    String profitMargin;
    //@JsonProperty("availableInventories") in case if we have diff name from jason and data reader file.
